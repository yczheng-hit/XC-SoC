...
void IMAGE<PIXEL>::allocbuf(int h, int w)
{
	int i, sz;
...
template <class PIXEL>
IMAGE<PIXEL>::IMAGE(IMAGE<PIXEL> *img)
{
	int sz, i;
...
template <class PIXEL>
IMAGE<PIXEL> *IMAGE<PIXEL>::crop(int y, int x,
								 int h, int w)
{
	IMAGE<PIXEL> *r;
	int xp, yp;
...
template <class PIXEL>
IMAGE<PIXEL> *IMAGE<PIXEL>::copy(void)
{
	IMAGE<PIXEL> *r;
	int ip, sz;
